<template>
  <div class="page-container about">
    <div id="about-content">
      ...
      a position I have held since January 2022. I am currently a member of the backend team, where we are using 
      the .NET framework to build REST APIs and quality server-side applications for our clients.Outside of 
      technology, I enjoy reading about history, philosophy, fantasy, and psychology. I also enjoy spending 
      time with my girlfriend Gina, my friends, and my family.
      </p>
    </div>
  </div>
</template>
